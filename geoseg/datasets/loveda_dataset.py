...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root='/mnt/workspace/ConvLSR-Net/data/LoveDA/train', img_dir='images_png', mosaic_ratio=0.25,
...
loveda_val_dataset = LoveDATrainDataset(data_root='/mnt/workspace/ConvLSR-Net/data/LoveDA/val', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='/mnt/workspace/ConvLSR-Net/data/LoveDA/test', img_dir='images_png',
