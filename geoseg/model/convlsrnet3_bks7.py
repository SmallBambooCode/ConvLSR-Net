...
#         # 原始的卷积分支
#         self.dwconv1 = nn.Conv2d(in_features, in_features // 4, kernel_size=1, stride=1)
...
#         # 添加新的5x5卷积分支
#         self.dwconv4 = nn.Conv2d(in_features, in_features // 4, kernel_size=5, stride=1, padding=2)
